"""Citizen-economy paired host-browser benchmark. Not a physical-phone/battery test.
...
with sync_playwright() as pw:
 ...
 for scenario in ['overview','fields']:
  for variant in ['baseline','economy','economy','baseline']:
