"""Settler daily-life paired host-browser benchmark. Not a physical-phone/battery test.
...
with sync_playwright() as pw:
 ...
 for scenario in ['overview','fields','neighborhood']:
  for variant in ['baseline','daily-life','daily-life','baseline']:
   ...
   page.evaluate({'overview':'centerTest(7000,4500,.1)','fields':'centerTest(2150,3900,.38)','neighborhood':'centerTest(areaSegundoBlocoMoradias.x+600,areaSegundoBlocoMoradias.y+450,1.25)'}[scenario])
