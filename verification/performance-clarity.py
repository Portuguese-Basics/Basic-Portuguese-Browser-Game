"""Paired host-browser benchmark. Not a physical-phone/battery test.
...
with sync_playwright() as pw:
 ...
 for scenario in ['overview','fields']:
  for variant in ['baseline','combined','combined','baseline']:
   ...
   page.evaluate('centerTest(7000,4500,.1)' if scenario=='overview' else 'centerTest(2150,3900,.38)')
